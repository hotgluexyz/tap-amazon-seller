...
def _transform_order_item_v2_to_v0(item: dict) -> dict:
    ...
    v0_item = {
        ...
        "ItemPrice": _extract_breakdown(breakdowns, "ITEM", default_currency=currency),
        "ShippingPrice": _extract_breakdown(breakdowns, "SHIPPING", default_currency=currency),
        "ItemTax": _extract_breakdown(breakdowns, "TAX", "ITEM", default_currency=currency),
        "ShippingTax": _extract_breakdown(breakdowns, "TAX", "SHIPPING", default_currency=currency),
        "PromotionDiscount": _extract_breakdown(breakdowns, "DISCOUNT", "ITEM", default_currency=currency),
        "PromotionDiscountTax": _extract_breakdown(breakdowns, "TAX", "DISCOUNT", default_currency=currency),
        "ShippingDiscount": _extract_breakdown(breakdowns, "DISCOUNT", "SHIPPING", default_currency=currency),
        "ShippingDiscountTax": None,  # included in PromotionDiscountTax in the new API
